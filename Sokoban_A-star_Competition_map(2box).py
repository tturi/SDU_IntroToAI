...
steps.append(Step(4, 7,"" ,False, 0, 3, 2, 3, 3))
...
def Solve(steps):
    while Solution == None and len(steps) != 0:
        ...
        steps.sort()
        if (3600.000 < (time.time() - start_time) < 3600.01) == True:
            print("The program visited", examined_node_counter, "nodes during the whole execution, and explored", explored_node_counter, "nodes, in:", time.time() - start_time, "[second].")
        if (7200.00 < (time.time() - start_time) < 7200.01) == True:
            print("The program visited", examined_node_counter, "nodes during the whole execution, and explored", explored_node_counter, "nodes, in:", time.time() - start_time, "[second].")
        if (10800.00 < (time.time() - start_time) < 10800.00) == True:
            print("The program visited", examined_node_counter, "nodes during the whole execution, and explored", explored_node_counter, "nodes, in:", time.time() - start_time, "[second].")
        if (14400.00 < (time.time() - start_time) < 14400.01) == True:
            print("The program visited", examined_node_counter, "nodes during the whole execution, and explored", explored_node_counter, "nodes, in:", time.time() - start_time, "[second].")
        if (18000.00 < (time.time() - start_time) < 18000.01) == True:
            print("The program visited", examined_node_counter, "nodes during the whole execution, and explored", explored_node_counter, "nodes, in:", time.time() - start_time, "[second].")
        if (21600.00 < (time.time() - start_time) < 21600.01) == True:
            print("The program visited", examined_node_counter, "nodes during the whole execution, and explored", explored_node_counter, "nodes, in:", time.time() - start_time, "[second].")
        if (25200.00 < (time.time() - start_time) < 25200.01) == True:
            print("The program visited", examined_node_counter, "nodes during the whole execution, and explored", explored_node_counter, "nodes, in:", time.time() - start_time, "[second].")
        if (28800.00 < (time.time() - start_time) < 28800.01) == True:
            print("The program visited", examined_node_counter, "nodes during the whole execution, and explored", explored_node_counter, "nodes, in:", time.time() - start_time, "[second].")
        if (32400.00 < (time.time() - start_time) < 32400.01) == True:
            print("The program visited", examined_node_counter, "nodes during the whole execution, and explored", explored_node_counter, "nodes, in:", time.time() - start_time, "[second].")
        if (36000.00 < (time.time() - start_time) < 36000.01) == True:
            print("The program visited", examined_node_counter, "nodes during the whole execution, and explored", explored_node_counter, "nodes, in:", time.time() - start_time, "[second].")
        if (39600.00 < (time.time() - start_time) < 39600.01) == True:
            print("The program visited", examined_node_counter, "nodes during the whole execution, and explored", explored_node_counter, "nodes, in:", time.time() - start_time, "[second].")
        if (43200.00 < (time.time() - start_time) < 43200.01) == True:
            print("The program visited", examined_node_counter, "nodes during the whole execution, and explored", explored_node_counter, "nodes, in:", time.time() - start_time, "[second].")
    if Solution != None:
